...
var Encoder7Bit = null;
// var OneWireUtils = require("./onewireutils");
var OneWireUtils = null;
// var com = require("./com");
var com = null;
...
SYSEX_RESPONSE[CAPABILITY_RESPONSE] = function(board) {
  ...
  console.log('capability: ', JSON.stringify(board.pins, null, 2));
...
Board.prototype.disableAnalogRead = function(pin, callback) {
  this.reportAnalogPin(pin, 0);
  this.removeListener("analog-read-" + pin, callback);
};
...
Board.prototype.disabledigitalRead = function(pin, callback) {
  this.reportDigitalPin(pin, 0);
  this.removeListener("digital-read-" + pin, callback);
};
...
Board.prototype.i2cStop = function(options) {
  ...
  var event = "I2C-reply-" + options.address + "-" + command;
